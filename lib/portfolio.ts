...
export const projects: Project[] = [
  {
    ...
    galleryImage: '3o5p9iMXPbpYiMVIUknkrftpT3ahZdyCKlWEQXORbSGjH0vq',
    teaserVariant: 'hero',
    order: 1,
    bgTheme: 'dark',
    proofType: 'metrics',
  ...
  },
  {
    ...
    mockupUrl: 'https://njcx3bqt2s.ufs.sh/f/3o5p9iMXPbpYiAuVvCnkrftpT3ahZdyCKlWEQXORbSGjH0vq',
  ...
  },
  {
    ...
    galleryBg: '#0A0A0A',
    galleryTheme: 'dark',
    galleryImageSize: 'full',
    proofType: 'visual',
    editorialStateOverride: 'preview',
    mockupUrl: 'https://njcx3bqt2s.ufs.sh/f/3o5p9iMXPbpYX7316TNuNYutrWogbeUyfcPqs1xTdpDIHK8n',
